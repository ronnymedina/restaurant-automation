...
export const LATAM_COUNTRIES: readonly LatamCountry[] = [
  { code: 'AR', name: 'Argentina',            currency: 'ARS', decimalSeparator: ',' },
  { code: 'BO', name: 'Bolivia',              currency: 'BOB', decimalSeparator: ',' },
  { code: 'BR', name: 'Brasil',               currency: 'BRL', decimalSeparator: ',' },
  { code: 'CL', name: 'Chile',                currency: 'CLP', decimalSeparator: ',' },
  { code: 'CO', name: 'Colombia',             currency: 'COP', decimalSeparator: ',' },
  { code: 'CR', name: 'Costa Rica',           currency: 'CRC', decimalSeparator: ',' },
  { code: 'CU', name: 'Cuba',                 currency: 'CUP', decimalSeparator: '.' },
  { code: 'DO', name: 'República Dominicana', currency: 'DOP', decimalSeparator: '.' },
  { code: 'EC', name: 'Ecuador',              currency: 'USD', decimalSeparator: '.' },
  { code: 'GT', name: 'Guatemala',            currency: 'GTQ', decimalSeparator: '.' },
  { code: 'HN', name: 'Honduras',             currency: 'HNL', decimalSeparator: '.' },
  { code: 'MX', name: 'México',               currency: 'MXN', decimalSeparator: '.' },
  { code: 'NI', name: 'Nicaragua',            currency: 'NIO', decimalSeparator: '.' },
  { code: 'PA', name: 'Panamá',               currency: 'PAB', decimalSeparator: '.' },
  { code: 'PE', name: 'Perú',                 currency: 'PEN', decimalSeparator: '.' },
  { code: 'PY', name: 'Paraguay',             currency: 'PYG', decimalSeparator: ',' },
  { code: 'SV', name: 'El Salvador',          currency: 'USD', decimalSeparator: '.' },
  { code: 'UY', name: 'Uruguay',              currency: 'UYU', decimalSeparator: ',' },
  { code: 'VE', name: 'Venezuela',            currency: 'VES', decimalSeparator: ',' },
] as const;
...
- En `setupCoreEntities`, derivar antes de crear:
  ...
  - `timezone` normalizado: si el del input **no pertenece** a los timezones del país
    (`countries-and-timezones`), usar el **primario** del país. Garantiza consistencia
