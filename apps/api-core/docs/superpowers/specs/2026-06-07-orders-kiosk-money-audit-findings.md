...
**Gap pendiente del ciclo anterior que sube de severidad este ciclo:** el "known gap" documentado en `orders.module.info.md` (`cancelOrder` sin optimistic concurrency) se materializa como pérdida monetaria → ver **R2-01**.
